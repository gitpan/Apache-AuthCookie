...
In the next release there will be a logout() method that will greatly
simplify the process of deleting someone's cookie.  I wanted to get
this release out the door though, so I didn't put it in this one.
